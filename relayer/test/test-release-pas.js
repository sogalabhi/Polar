 ...
 * 
 * Usage: node test/test-release-pas.js <amount_pas> <to_address>
 * Example: node test/test-release-pas.js 0.1 0xYourMetaMaskAddress
 */
...
async function releasePas(amount, toAddress) {
    console.log('\n💸 ═══════════════════════════════════════════');
    ...
    try {
        ...
        console.log(`   ${CONFIG.EVM_EXPLORER_URL}/tx/${tx.hash}`);
        console.log('');
...
if (args.length < 2) {
    console.log('\n📖 Usage: node test/test-release-pas.js <amount_pas> <to_address>');
    console.log('   Example: node test/test-release-pas.js 0.1 0xYourMetaMaskAddress\n');
    process.exit(1);
}

releasePas(amount, toAddress);
